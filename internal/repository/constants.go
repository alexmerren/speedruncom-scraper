...
const (
	...
	AdditionalLeaderboardsDataFilename = "./data/v1/additional-leaderboards-data.csv"
...
var (
	FileColumnDefinitions = map[string][]string{
		...
		AdditionalLeaderboardsDataFilename: {"runId", "gameId", "categoryId", "levelId", "place", "date", "primaryTime", "platform", "isEmulated", "players", "examiner", "verifiedDate", "variablesAndValues"},
	...
	FileComments = map[string]string{
		...
		AdditionalLeaderboardsDataFilename: "#additional-leaderboads-data.csv",
