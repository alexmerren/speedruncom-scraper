...
var (
	FileColumnDefinitions = map[string][]string{
		...
		RunsDataFilename:                     {"runId", "gameId", "categoryId", "levelId", "date", "primaryTime", "realTime", "realTimeNoLoads", "inGameTime", "platform", "isEmulated", "players", "examiner", "variablesAndValues", "verifiedDate", "status", "statusReason"},
