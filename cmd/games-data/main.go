...
func main() {
	if err := getGameDataV1(); err != nil {
		fmt.Fprintf(os.Stderr, "error: %v\n", err)
		os.Exit(1)
	}
}

func getGameDataV1() error {
	...
	err = srcomv1.ProcessGamesData(inputFile, gamesOutputFile, categoriesOutputFile, levelsOutputFile, variablesOutputFile, valuesOutputFile)
	if err != nil {
		return err
	}
